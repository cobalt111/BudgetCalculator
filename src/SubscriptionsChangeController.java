...
public class SubscriptionsChangeController implements Initializable {
    ...
    private void onSubmitChange() {
        ...
        database.updateBudget("Subscriptions", Integer.parseInt(submissionAmountField.getText())*100);
        openBudgetLoader();
    }
